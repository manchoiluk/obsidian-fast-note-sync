...
export default {
  ...
  "setting.sync.hash_limit_toggle": "Limit Hash Computations per Cycle",
  "setting.sync.hash_limit_toggle_desc": "When enabled, limits the number of file hashes computed in a single sync cycle to prevent Out-Of-Memory (OOM) crashes in large vaults. When disabled, there is no limit.",
  "setting.sync.hash_limit": "Maximum Hash Computations Limit",
  "setting.sync.hash_limit_desc": "The maximum number of files allowed to be hashed in a single sync cycle. Files exceeding the limit will be processed in subsequent sync cycles. Default value is 20000.",
