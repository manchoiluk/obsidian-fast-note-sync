...
export default {
  ...
  "setting.sync.hash_limit_toggle": "1회당 해시 계산 개수 제한",
  "setting.sync.hash_limit_toggle_desc": "활성화하면 단일 동기화 주기에서 계산할 파일 해시 수가 제한되어 대형 보관소에서 메모리 부족(OOM)으로 인한 충돌을 방지합니다. 비활성화하면 제한이 적용되지 않습니다.",
  "setting.sync.hash_limit": "최대 해시 계산 제한 개수",
  "setting.sync.hash_limit_desc": "단일 동기화 주기 내에 해시 계산을 수행할 수 있는 최대 파일 수입니다. 이 제한을 초과하는 파일은 이후의 동기화 주기에서 계속 처리됩니다. 기본값은 20000입니다.",
